...
namespace OriAscendant.Core
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (ServiceLocator.TryGet(out CrossroadsSystem crossroads)) crossroads.Begin(save);
        ...
        private void AdoptCloudSave(SaveData cloud)
        {
            ...
            if (ServiceLocator.TryGet(out CrossroadsSystem crossroads)) crossroads.Begin(cloud);
